(function ()
{
    ...
    /** @ngInject */
    function msMaterialColorPickerController($scope, $mdColorPalette, $mdMenu, misapayGenerator)
    {
        var vm = this;
        ...
        function updateSelectedColor(palette, hue)
        {
            vm.selectedColor = {
                ...
                bgColorValue: misapayGenerator.rgba(vm.palettes[palette][hue].value),
                fgColorValue: misapayGenerator.rgba(vm.palettes[palette][hue].contrast)
            };
