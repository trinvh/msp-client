(function ()
{
    ...
    /** @ngInject */
    function msScrollDirective($timeout, msScrollConfig, msUtils, misapayConfig)
    {
        return {
            restrict: 'AE',
            compile : function (tElement)
            {
                ...
                if ( misapayConfig.getConfig('disableCustomScrollbars') )
                {
                    return;
                }
                ...
                if ( misapayConfig.getConfig('disableCustomScrollbarsOnMobile') && msUtils.isMobile() )
                {
                    return;
                }
