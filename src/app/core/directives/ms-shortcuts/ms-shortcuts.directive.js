(function ()
{
    ...
    function MsShortcutsController($scope, $cookies, $document, $timeout, $q, msNavigationService)
    {
        ...
        function loadShortcuts()
        {
            ...
            var shortcuts = angular.fromJson($cookies.get('misapay.shortcuts'));
            ...
            if ( angular.isUndefined(shortcuts) )
            {
                ...
                $cookies.put('misapay.shortcuts', angular.toJson(shortcuts));
            }
        ...
        function saveShortcuts()
        {
            ...
            $cookies.put('misapay.shortcuts', angular.toJson(vm.shortcuts));
