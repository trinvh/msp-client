(function ()
{
    ...
    angular
        .module('app.core')
        .factory('misapayGenerator', misapayGeneratorService);

    /** @ngInject */
    function misapayGeneratorService($cookies, $log, misapayTheming)
    {
        ...
        function generate()
        {
            ...
            var registeredThemes = angular.copy(misapayTheming.getRegisteredThemes());
            var registeredPalettes = angular.copy(misapayTheming.getRegisteredPalettes());
        ...
        function processAndStoreThemes(_themes)
        {
            ...
            misapayTheming.setThemesList(themes);
            ...
            if ( selectedTheme )
            {
                misapayTheming.setActiveTheme(selectedTheme);
            }
            else
            {
                misapayTheming.setActiveTheme('default');
            }
        }
