(function ()
{
    ...
    /** @ngInject */
    function MsThemeOptionsController($cookies, misapayTheming)
    {
        var vm = this;
        ...
        {
            misapayTheming.setActiveTheme(themeName);
        }
        ...
        {
            return misapayTheming.themes.active;
        }
        ...
        return {
            ...
            compile    : function (tElement)
            {
                ...
                return function postLink(scope)
                {
                    ...
                    {
                        // Toggle the misapay theme options panel
                        $mdSidenav('misapay-theme-options').toggle();
                    }
