(function () {
	...
	/** @ngInject */
	function MaterialController($scope, $state, $mdDialog, $mdToast, api) {
		var vm = this;
		...
		vm.getPromise = function () {
			vm.promise = api.material.get(vm.filter.query, vm.success).$promise;
		};
		...
		vm.destroy = function (item) {
			...
			$mdDialog.show(confirm).then(function () {
				api.material.delete(item, function () {
					$mdToast.show(
						$mdToast.simple()
